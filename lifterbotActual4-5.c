...
#pragma config(Motor,  port5,           rampLeft,      tmotorVex393_MC29, openLoop, reversed, driveLeft)
...
#pragma config(Motor,  port8,           backRight,     tmotorVex393_MC29, openLoop, reversed, driveRight)
...
task autonomous()
{
	int t = 0;  //  run the motor for 1 second, then until it is cocked.
	while (true)
	{
		if (SensorValue[catapultCocked] == 0 || t < 1000)
		{
			motor[catapultRight] = 127;
			motor[catapultLeft] = 127;
		} else {
