...
int upperSpeed = 0;
int gateSpeed = 0;
int maxLauncherSpeed = 80;
int incDelay = incDelayAmount;
int per = 200;
int kp = 2;
int kpden = 5;
int ki = 0;
...
task usercontrol()
{
	...
	while (true)
	{
		...
		// Launcher
		// NEW CODE:
		// Attempting slower incrementing of launcherspeed by requireing the button to remain pressed for incDelay times
