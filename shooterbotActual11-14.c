...
int upperSpeed = 0;
int gateSpeed = 0;
int maxLauncherSpeed = 160;  // was 127;
int per  = 200;   // was 200 11/7
int kp    = 3;    // was 2   11/7
int kpden = 10;    // was 5   11/7
int ki    = 2;    // was 2   11/7, still stable no load
int kiden = 10;   // was 10  11/7
int kd    = 3;    // was 1   11/7
int kdden = 5;    // was 5   11/7
int monitoredMotorSpeedR = 0;
int monitoredCurrentPosR = 0;
int monitoredActualSpeedR = 0;
//int victory = 0;
...
// NEW PID needs checking
// newspeed = desiredspeed + error terms
task Pid1() {
	int prevPos = 0;
	int currentPos = 0;
	int actualSpeed = 0;
	...
	while (true) {
		...
		monitoredCurrentPosR = currentPos; // for debugging
		actualSpeed = (currentPos - prevPos);
		monitoredActualSpeedR = actualSpeed; // for debugging
